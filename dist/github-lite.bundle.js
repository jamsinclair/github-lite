(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.GitHubLite = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(_dereq_,module,exports){
...
},{"object-assign":2,"strict-uri-encode":4}],4:[function(_dereq_,module,exports){
'use strict';
...
var _btoaLite = _dereq_('btoa-lite');
...
},{"btoa-lite":1,"query-string":3,"whatwg-fetch":5}],7:[function(_dereq_,module,exports){
'use strict';
...
var _pulls = _dereq_('./pulls');

var _pulls2 = _interopRequireDefault(_pulls);

var _repos = _dereq_('./repos');

var _repos2 = _interopRequireDefault(_repos);

var _paging = _dereq_('./paging');

var _paging2 = _interopRequireDefault(_paging);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

},{"./client":7,"./paging":9,"./pulls":10,"./repos":11}],9:[function(_dereq_,module,exports){
'use strict';
...
},{"./api":6}],10:[function(_dereq_,module,exports){
'use strict';
...
var PullRequestsApi = function (_BaseGitHubApi) {
  _inherits(PullRequestsApi, _BaseGitHubApi);

  function PullRequestsApi() {
    _classCallCheck(this, PullRequestsApi);

    return _possibleConstructorReturn(this, (PullRequestsApi.__proto__ || Object.getPrototypeOf(PullRequestsApi)).apply(this, arguments));
  }

  _createClass(PullRequestsApi, [{
    key: 'list',
    value: function list(owner, repo, params) {
...
},{"./api":6}],11:[function(_dereq_,module,exports){
'use strict';
...
var RepositoriesApi = function (_BaseGitHubApi) {
  _inherits(RepositoriesApi, _BaseGitHubApi);

  function RepositoriesApi() {
    _classCallCheck(this, RepositoriesApi);

    return _possibleConstructorReturn(this, (RepositoriesApi.__proto__ || Object.getPrototypeOf(RepositoriesApi)).apply(this, arguments));
  }

  _createClass(RepositoriesApi, [{
    key: 'list',
    value: function list(user, params) {
      var apiRoute = user ? '/users/' + user + '/repos' : '/user/repos';
      return this.doRequest(apiRoute, { query: params });
    }
  }, {
    key: 'listByOrg',
    value: function listByOrg(org, params) {
      return this.doRequest('/orgs/' + org + '/repos', { query: params });
    }
  }, {
    key: 'getCombinedStatus',
    value: function getCombinedStatus(owner, repo, ref) {
